...
func newSystemConfig(db *gorm.DB, opts ...gen.DOOption) systemConfig {
	...
	_systemConfig.ConfigKey = field.NewString(tableName, "config_key")
	_systemConfig.ConfigValue = field.NewString(tableName, "config_value")
...
type systemConfig struct {
	...
	ALL         field.Asterisk
	ID          field.Int64  // 自增ID
	ConfigKey   field.String // 配置键名
	ConfigValue field.String // 配置值(JSON格式)
