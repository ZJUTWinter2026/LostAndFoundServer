...
func (a *announcement) WithContext(ctx context.Context) IAnnouncementDo {
	return a.announcementDo.WithContext(ctx)
}

func (a announcement) TableName() string { return a.announcementDo.TableName() }

func (a announcement) Alias() string { return a.announcementDo.Alias() }

func (a announcement) Columns(cols ...field.Expr) gen.Columns {
	return a.announcementDo.Columns(cols...)
}
